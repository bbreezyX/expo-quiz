            ...
            sessions.map((s) => {
              ...
              return (
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`group flex items-center justify-between p-4 rounded-2xl border cursor-pointer transition-shadow ${
                    isActive ? "shadow-lg shadow-slate-300" : "hover:shadow-sm"
                  }`}
                >
